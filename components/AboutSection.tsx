...
export default function AboutSection() {
  return (
    <main className="bg-[#0c0c0c] text-white">
      <div
        className="flex h-screen items-center justify-center text-center text-[5.98958vw] leading-none whitespace-nowrap"
      ...
      <div className="mx-auto flex max-w-[93.90625vw] flex-col gap-[6.25vw] pt-[10.41667vw] pb-[3.125vw]">
        {/* Name + intro */}
        <Section>
          <div className="flex items-start justify-between">
            ...
            <div className="flex w-[48.48958vw] flex-col gap-[1.041667vw] text-[1.145833vw] leading-[2.1875vw] font-bold">
              <p>
              ...
              {CV_ENTRIES.map((entry) => (
                <div key={entry.title} className="flex items-start" style={{ gap: `${entry.gapVw}vw` }}>
                  ...
                  <div className="flex flex-1 flex-col">
                    <p className="-mb-[0.78125vw] text-[1.145833vw] leading-[2.86458vw] font-bold">
                      {entry.title}
                    </p>
                    <p className="text-[1.145833vw] leading-[2.86458vw] opacity-80">
                      {entry.subtitle}
                    </p>
                  </div>
                </div>
        ...
        {/* Category grid */}
        <Section>
          <div className="flex items-start text-[1.145833vw]" style={{ gap: "9.244792vw" }}>
        ...
        <Section>
          <div className="flex items-start justify-between">
            ...
            <div className="flex w-[48.64583vw] flex-col gap-[1.5625vw]">
              <div className="flex flex-col gap-[0.3125vw] text-[1.145833vw] font-bold">
