      ...
      <div className="mx-auto flex max-w-[93.90625vw] flex-col gap-[13.94231vw] pt-[10.5128vw] pr-[2.5641vw] pb-[3.125vw] pl-[1.28205vw] md:gap-[6.25vw] md:pt-[10.41667vw] md:pr-0 md:pl-0">
        ...
        <Section>
          <div className="flex flex-col gap-[7.17949vw] px-[1.02564vw] md:flex-row md:items-start md:justify-between md:gap-0 md:px-0">
            <div className="flex flex-row gap-[2.5641vw] text-[4.87179vw] leading-none font-bold md:w-[11.40625vw] md:flex-col md:gap-0 md:pl-[0.520833vw] md:text-[1.25vw] md:leading-[2.1875vw]">
              <p>UZUN CHOI</p>
              <p>최우준</p>
            </div>
            <div className="flex flex-col gap-[3.07692vw] font-medium opacity-80 md:w-[48.48958vw] md:gap-[1.041667vw] md:text-[1.145833vw] md:font-bold md:opacity-100">
              <p className="text-[4.35897vw] leading-[6.15385vw] md:text-[1.145833vw] md:leading-[2.1875vw]">
              ...
              <p className="text-[4.10256vw] leading-[6.66667vw] md:text-[1.145833vw] md:leading-[2.1875vw]">
        ...
        <Section>
          <div className="flex flex-col gap-[7.17949vw] px-[1.02564vw] md:flex-row md:items-start md:justify-between md:gap-0 md:px-0">
            <p className="text-[4.87179vw] font-bold whitespace-nowrap md:pl-[0.520833vw] md:text-[1.25vw]">CV</p>
            <div className="flex flex-col gap-[4.10256vw] opacity-80 md:w-[48.64583vw] md:gap-[0.989583vw] md:opacity-100">
              {CV_ENTRIES.map((entry) => (
                ...
                >
                  <p
                    className="shrink-0 text-[4.35897vw] leading-none whitespace-nowrap md:w-[var(--desktop-width)] md:text-[1.25vw] md:leading-[2.86458vw]"
                  ...
                  <div className="-mt-[0.76923vw] flex flex-1 flex-col gap-[2.05128vw] md:mt-0 md:gap-0">
                    <p className="text-[4.35897vw] leading-[5.89744vw] font-medium md:-mb-[0.78125vw] md:text-[1.145833vw] md:leading-[2.86458vw] md:font-bold">
                      {entry.title}
                    </p>
                    <p className="text-[4.10256vw] leading-none opacity-80 md:text-[1.145833vw] md:leading-[2.86458vw]">
                      {entry.subtitle}
                    </p>
                  </div>
                </div>
        ...
        <Section>
          <div className="grid grid-cols-2 items-start gap-x-[6.5vw] gap-y-[6.15385vw] px-[1.02564vw] md:flex md:grid-cols-none md:gap-[9.24487vw] md:px-0">
            {CATEGORIES.map((cat, i) => (
              ...
              >
                <p className="text-[4.87179vw] font-bold md:whitespace-nowrap md:text-[1.145833vw]">{cat.label}</p>
                <div className="flex flex-col gap-[0.25641vw] text-[4.35897vw] opacity-80 md:gap-[0.260417vw] md:text-[1.145833vw]">
                  {cat.items.map((item) => (
        ...
        <Section>
          <div className="flex flex-col gap-[7.17949vw] px-[1.02564vw] md:flex-row md:items-start md:justify-between md:gap-0 md:px-0">
            <p className="text-[4.87179vw] font-bold whitespace-nowrap md:pl-[0.520833vw] md:text-[1.25vw]">CONTACT</p>
            <div className="flex flex-col gap-[2.05128vw] opacity-80 md:w-[48.64583vw] md:gap-[1.5625vw] md:opacity-100">
              <div className="flex flex-col gap-[0.51282vw] text-[4.10256vw] font-medium md:gap-[0.3125vw] md:text-[1.145833vw] md:font-bold">
              ...
              <div className="flex items-center gap-[2.05128vw] md:gap-[0.78125vw]">
                <CopyEmailLink
                  ...
                  className="text-[4.10256vw] font-normal text-white/90 transition-colors hover:text-white md:text-[1.25vw] md:font-bold"
